...
public class Zou {
        public static final RegistryKey<Biome> ZOU = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "zou"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(ZOU, testBiome(context));
    }
