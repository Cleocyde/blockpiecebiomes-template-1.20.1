...
public class GreenBit {
        public static final RegistryKey<Biome> GREEN_BIT = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "green_bit"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(GREEN_BIT, testBiome(context));
    }
