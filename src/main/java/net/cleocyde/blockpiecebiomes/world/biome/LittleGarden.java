...
public class LittleGarden {
        public static final RegistryKey<Biome> LITTLE_GARDEN = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "little_garden"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(LITTLE_GARDEN, testBiome(context));
    }
