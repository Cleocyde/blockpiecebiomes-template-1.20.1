...
public class WanoCapital {
        public static final RegistryKey<Biome> WANO_CAPITAL = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "wano_capitale_des_fleurs"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WANO_CAPITAL, testBiome(context));
    }
