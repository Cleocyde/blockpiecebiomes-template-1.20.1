...
public class WaterSeven {
        public static final RegistryKey<Biome> WATER_SEVEN = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "water_seven"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WATER_SEVEN, testBiome(context));
    }
