...
public class WanoKuri {
        public static final RegistryKey<Biome> WANO_KURI = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "wano_kuri"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WANO_KURI, testBiome(context));
    }
