...
public class Yukiryu {
        public static final RegistryKey<Biome> YUKIRYU = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "yukiryu"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(YUKIRYU, testBiome(context));
    }
