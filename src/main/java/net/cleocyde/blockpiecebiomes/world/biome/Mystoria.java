...
public class Mystoria {
        public static final RegistryKey<Biome> MYSTORIA = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "mystoria"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(MYSTORIA, testBiome(context));
    }
