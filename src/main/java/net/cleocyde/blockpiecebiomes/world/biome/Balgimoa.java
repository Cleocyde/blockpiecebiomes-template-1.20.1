...
public class Balgimoa {
        public static final RegistryKey<Biome> BALGIMOA = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "balgimoa"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(BALGIMOA, testBiome(context));
    }
