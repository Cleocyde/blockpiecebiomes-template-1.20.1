...
public class Alabasta {
        public static final RegistryKey<Biome> ALABASTA = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "alabasta"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(ALABASTA, testBiome(context));
    }
