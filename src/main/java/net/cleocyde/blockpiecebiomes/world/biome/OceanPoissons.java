...
public class OceanPoissons {
        public static final RegistryKey<Biome> OCEAN_POISSONS = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "ocean_des_hommes_poisson"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(OCEAN_POISSONS, testBiome(context));
    }
