...
public class RiskyRed {
        public static final RegistryKey<Biome> RISKY_RED = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "risky_red"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(RISKY_RED, testBiome(context));
    }
