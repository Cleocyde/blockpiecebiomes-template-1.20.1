...
public class KaraiBari {
        public static final RegistryKey<Biome> KARAI_BARI = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "kalai_bali"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(KARAI_BARI, testBiome(context));
    }
