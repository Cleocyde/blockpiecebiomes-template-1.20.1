...
public class Raijin {
        public static final RegistryKey<Biome> RAIJIN = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "raijin"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(RAIJIN, testBiome(context));
    }
