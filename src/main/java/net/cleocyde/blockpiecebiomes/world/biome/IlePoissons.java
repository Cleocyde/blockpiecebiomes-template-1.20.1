...
public class IlePoissons {
        public static final RegistryKey<Biome> ILE_POISSONS = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "ile_des_hommes_poisson"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(ILE_POISSONS, testBiome(context));
    }
