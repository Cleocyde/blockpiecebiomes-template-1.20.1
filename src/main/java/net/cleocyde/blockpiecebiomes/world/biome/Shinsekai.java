...
public class Shinsekai {
        public static final RegistryKey<Biome> SHINSEKAI = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "shinsekai"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(SHINSEKAI, testBiome(context));
    }
