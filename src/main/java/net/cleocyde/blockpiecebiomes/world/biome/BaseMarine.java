...
public class BaseMarine {
        public static final RegistryKey<Biome> BASE_MARINE = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "base_marine"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(BASE_MARINE, testBiome(context));
    }
