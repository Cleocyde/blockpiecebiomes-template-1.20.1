...
public class BrockCollie {
        public static final RegistryKey<Biome> BROCK_COLLIE = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "brock_collie"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(BROCK_COLLIE, testBiome(context));
    }
