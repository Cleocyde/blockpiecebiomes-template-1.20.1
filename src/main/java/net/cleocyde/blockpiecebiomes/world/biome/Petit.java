...
public class Petit {
        public static final RegistryKey<Biome> PETIT = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "petit"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(PETIT, testBiome(context));
    }
