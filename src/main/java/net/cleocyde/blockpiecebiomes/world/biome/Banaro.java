...
public class Banaro {
        public static final RegistryKey<Biome> BANARO = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "banaro"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(BANARO, testBiome(context));
    }
