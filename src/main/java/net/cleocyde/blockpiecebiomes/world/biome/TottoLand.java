...
public class TottoLand {
        public static final RegistryKey<Biome> TOTTO_LAND = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "totto_land"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(TOTTO_LAND, testBiome(context));
    }
