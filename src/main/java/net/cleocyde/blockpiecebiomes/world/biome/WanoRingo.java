...
public class WanoRingo {
        public static final RegistryKey<Biome> WANO_RINGO = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "wano_ringo"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WANO_RINGO, testBiome(context));
    }
