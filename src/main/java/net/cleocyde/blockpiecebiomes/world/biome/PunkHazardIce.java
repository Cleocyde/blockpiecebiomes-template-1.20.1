...
public class PunkHazardIce {
        public static final RegistryKey<Biome> PUNK_HAZARD_ICE = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "punk_hazard_glace"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(PUNK_HAZARD_ICE, testBiome(context));
    }
