...
public class WanoHakumai {
        public static final RegistryKey<Biome> WANO_HAKUMAI = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "wano_hakumai"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WANO_HAKUMAI, testBiome(context));
    }
