...
public class ImpelDown {
        public static final RegistryKey<Biome> IMPEL_DOWN = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "impel_down"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(IMPEL_DOWN, testBiome(context));
    }
