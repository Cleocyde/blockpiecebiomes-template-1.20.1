...
public class Dressrosa {
        public static final RegistryKey<Biome> DRESSROSA = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "dressrosa"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(DRESSROSA, testBiome(context));
    }
