...
public class RedLine {
        public static final RegistryKey<Biome> REDLINE = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "red_line"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(REDLINE, testBiome(context));
    }
