...
public class WanoOnigashima {
        public static final RegistryKey<Biome> WANO_ONIGASHIMA = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "wano_onigashima"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WANO_ONIGASHIMA, testBiome(context));
    }
