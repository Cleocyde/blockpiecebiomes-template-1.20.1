...
public class LodeStar {
        public static final RegistryKey<Biome> LODE_STAR = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "lode_star"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(LODE_STAR, testBiome(context));
    }
