...
public class Jaya {
        public static final RegistryKey<Biome> JAYA = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "jaya"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(JAYA, testBiome(context));
    }
