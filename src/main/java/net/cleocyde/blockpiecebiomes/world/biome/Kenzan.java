...
public class Kenzan {
        public static final RegistryKey<Biome> KENZAN = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "kenzan"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(KENZAN, testBiome(context));
    }
