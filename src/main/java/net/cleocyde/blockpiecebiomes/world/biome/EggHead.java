...
public class EggHead {
        public static final RegistryKey<Biome> EGG_HEAD = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "egg_head"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(EGG_HEAD, testBiome(context));
    }
