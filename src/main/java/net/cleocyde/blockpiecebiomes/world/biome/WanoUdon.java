...
public class WanoUdon {
        public static final RegistryKey<Biome> WANO_UDON = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "wano_udon"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(WANO_UDON, testBiome(context));
    }
