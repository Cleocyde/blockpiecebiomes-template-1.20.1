...
public class LaughTale {
        public static final RegistryKey<Biome> LAUGH_TALE = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "laugh_tale"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(LAUGH_TALE, testBiome(context));
    }
