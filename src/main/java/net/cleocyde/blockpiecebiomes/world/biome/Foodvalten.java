...
public class Foodvalten {
        public static final RegistryKey<Biome> FOODVALTEN = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "foodvalten"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(FOODVALTEN, testBiome(context));
    }
