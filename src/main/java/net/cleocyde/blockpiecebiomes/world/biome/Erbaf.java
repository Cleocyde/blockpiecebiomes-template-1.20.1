...
public class Erbaf {
        public static final RegistryKey<Biome> ERBAF = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "erbaf"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(ERBAF, testBiome(context));
    }
