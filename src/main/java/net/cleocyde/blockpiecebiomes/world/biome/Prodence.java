...
public class Prodence {
        public static final RegistryKey<Biome> PRODENCE = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "royaume_de_prodence"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(PRODENCE, testBiome(context));
    }
