...
public class AmazonLily {
        public static final RegistryKey<Biome> AMAZON_LILY = RegistryKey.of(RegistryKeys.BIOME,
                new Identifier(BlockPieceBiomes.MOD_ID, "amazon_lily"));

    public static void boostrap(Registerable<Biome> context) {
        context.register(AMAZON_LILY, testBiome(context));
    }
